...
SECRET_KEY = 'g_l0@7=ct_w&6mhn-5^gq-=vo&bqi8qkdp57(yxlqkcfe(0uzs'
...
CRONJOBS = [
    ...
    ('*/1 * * * *', 'contents.crons.generate_static_index_html', '>> /home/python/python/Django/meiduoshangcheng/mall/logs/crontab.log')
]
...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        'URL': 'http://192.168.142.150:9200/',  # 此处为elasticsearch运行的服务器ip地址，端口号固定为9200
